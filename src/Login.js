    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh', backgroundColor: '#f8f9fa', fontFamily: 'Arial, sans-serif' }}>
            <div style={{ width: '100%', maxWidth: '400px', padding: '30px', backgroundColor: '#ffffff', borderRadius: '8px', boxShadow: '0 4px 12px rgba(0,0,0,0.05)', boxSizing: 'border-box' }}>
                <h1 style={{ color: '#007bff', fontSize: '32px', fontWeight: 'bold', margin: '0 0 10px 0', textAlign: 'center' }}>E-Voting Portal</h1>
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <button type="button" onClick={() => window.location.href = "/register"} style={{ width: '100%', padding: '12px', backgroundColor: '#6c757d', color: '#ffffff', border: 'none', borderRadius: '6px', fontSize: '16px', fontWeight: 'bold', cursor: 'pointer' }}>
                        Create Account
                    </button>
                </form>
            </div>
